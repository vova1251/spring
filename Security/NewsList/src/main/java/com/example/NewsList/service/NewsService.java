...
public class NewsService {
    ...
    @Autowired
    public NewsService(NewsRepository newsRepository, UserRepository userRepository, NewsCategoryRepository newsCategoryRepository, NewsMapper newsMapper, UserService userService) {
