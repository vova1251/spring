...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, OrderStatus> kafkaMessageProducerFactory(ObjectMapper objectMapper) {
    ...
    @Bean
    public KafkaTemplate<String, OrderStatus> KafkaTemplate(ProducerFactory<String, OrderStatus> kafkaMessageProducerFactory) {
